...
class StoreOrderLines(BaseApi):
    ...
    async def create(self, store_id, order_id, data):
        """
        ...
        response = await self._mc_client._post(url=self._build_path(store_id, 'orders', order_id, 'lines'))
    ...
    async def all(self, store_id, order_id, get_all=False, **queryparams):
        """
        ...
        self.line_id = None
        if get_all:
            return await self._iterate(url=self._build_path(store_id, 'orders', order_id, 'lines'), **queryparams)
        else:
            return await self._mc_client._get(url=self._build_path(store_id, 'orders', order_id, 'lines'), **queryparams)


    async def get(self, store_id, order_id, line_id, **queryparams):
        """
        ...
        return await self._mc_client._get(url=self._build_path(store_id, 'orders', order_id, 'lines', line_id), **queryparams)


    async def update(self, store_id, order_id, line_id, data):
        """
        ...
        self.order_id = order_id
        self.line_id = line_id
        return await self._mc_client._patch(url=self._build_path(store_id, 'orders', order_id, 'lines', line_id), data=data)


    async def delete(self, store_id, order_id, line_id):
        """
        ...
        self.order_id = order_id
        self.line_id = line_id
        return await self._mc_client._delete(url=self._build_path(store_id, 'orders', order_id, 'lines', line_id))
